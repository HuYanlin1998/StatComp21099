...
RcppExport SEXP _StatComp21099_gibbsC(SEXP NSEXP, SEXP thinSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _StatComp21099_vaccC(SEXP ageSEXP, SEXP femaleSEXP, SEXP ilySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_StatComp21099_gibbsC", (DL_FUNC) &_StatComp21099_gibbsC, 2},
    {"_StatComp21099_vaccC", (DL_FUNC) &_StatComp21099_vaccC, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_StatComp21099(DllInfo *dll) {
