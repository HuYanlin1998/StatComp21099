---
title: "Introduction to StatComp21099"
author: "Yanlin Hu"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Introduction to StatComp21099}
...
__StatComp21099__ is a simple R package developed to implement classic logrank test and its expand ,say, Fleming-Harrington and Peto&Peto weight test,not only based on big sample approximation,but permutation test.Three functions are considered,namely _tableCalculation_(Calculate the statistic which is used to test difference between two survival curves), _SurvFuncEsti_(Kaplan-Meier estimate for survival function ) _survtest_ (test if there is a difference between two survival curves using Harrington and Fleming or Peto & Peto method,based on big sample theory and permutation test).


## Test

The source R code for _tableCalculation_ is as follows:
...
The source R code for _SurvFuncEsti_ is as follows:
...
The source R code for _survtest_ is as follows:
